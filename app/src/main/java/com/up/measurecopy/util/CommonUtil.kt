...
object CommonUtil {
    ...
    fun makeSign(paramsMap: MutableMap<String, String>): String {
    ...
    private fun getUrlParams(sortedMap: Map<String, String>): String {
    ...
    private fun sortMapByKey(paramsMap: MutableMap<String, String>): Map<String, String> {
