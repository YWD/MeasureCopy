package com.up.measurecopy.view.convenientbanner;
...
import com.up.measurecopy.view.convenientbanner.adapter.CBPageAdapter;
import com.up.measurecopy.view.convenientbanner.holder.CBViewHolderCreator;
import com.up.measurecopy.view.convenientbanner.listener.CBPageChangeListener;
import com.up.measurecopy.view.convenientbanner.listener.OnItemClickListener;
import com.up.measurecopy.view.convenientbanner.view.CBLoopViewPager;
    ...
    private Runnable adSwitchTask = new Runnable() {
        ...
        public void run() {
            if (viewPager != null && turning) {
                ...
                Log.d("ywd", "autoTurningTime:" + autoTurningTime);
            }
        }
    };
